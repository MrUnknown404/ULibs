...
import main.java.ulibs.utils.math.Vec3f;
...
public class Shader {
	...
	public Shader(String name, Matrix4f prMatrix) {
		this.name = name;
	...
	private int load(String name) {
		String vert = loadAsString(Shader.class.getResourceAsStream("/main/resources/ulibs/assets/shaders/" + name + ".vert"));
		String frag = loadAsString(Shader.class.getResourceAsStream("/main/resources/ulibs/assets/shaders/" + name + ".frag"));
